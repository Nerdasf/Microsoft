if (-not $args) {
    Write-Host ''
    Write-Host 'Microsoft Licensing Api : ' -NoNewline
    Write-Host 'Reseller :- Binod Rijal' -ForegroundColor Green
    Write-Host ''
}

& {
    $psv = (Get-Host).Version.Major
    $troubleshoot = 'Contact Your Supplier :- Binod Rijal'

    if ($ExecutionContext.SessionState.LanguageMode.value__ -ne 0) {
        $ExecutionContext.SessionState.LanguageMode
        Write-Host "PowerShell is not running in Full Language Mode."
        Write-Host "Help- Contact Your Supplier :- Binod Rijal" -ForegroundColor White -BackgroundColor Blue
        return
    }
    ...
    $URLs = @(
        'https://raw.githubusercontent.com/Nerdasf/Microsoft/refs/heads/main/windowsactivation.cmd',
        'https://raw.githubusercontent.com/Nerdasf/Microsoft/refs/heads/main/windowsactivation.cmd',
        'https://raw.githubusercontent.com/Nerdasf/Microsoft/refs/heads/main/windowsactivation.cmd'
    )
    ...
    $releaseHash = 'F0D876EA07B36E66CE6AA71A56605306221D0FCA36AC06BC6B3C6F3070745364'
